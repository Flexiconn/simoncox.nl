...
function Archive() {
    return ( <div className="Main">
        <div>
            ...
            <ProjectCard buttons={[{name: "Demo", link:"https://www.simoncox.nl/"}, {name: "Source",link:"https://www.simoncox.nl/"}]} name="CMS" description="A CMS to make very basic webpages with auth0 as identity provider"></ProjectCard>
            <ProjectCard buttons={[{name: "Demo" ,link:"https://www.simoncox.nl/"}, {name: "Source" ,link:"https://www.simoncox.nl/"}]} name="Cliverr" description="Fiverr clone made with ASP.NET mvc."></ProjectCard>
            <ProjectCard buttons={[{name: "Demo" ,link:"https://www.simoncox.nl/"},{name: "Front-end source" ,link:"https://www.simoncox.nl/"}, {name: "Back-end source" ,link:"https://www.simoncox.nl/"}]} name="Circus train" description="Program to sort animal into train carts."></ProjectCard>
